...
public class Account {
	...
	public static Predicate<Account> checkBound = a -> {boolean p = lowerBound.test(a), q = upperBound.test(a); return p && q; };
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker = null;//(n) -> { a -> a.balance += n; };
